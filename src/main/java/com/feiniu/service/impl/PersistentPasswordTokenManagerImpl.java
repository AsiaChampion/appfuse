...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.feiniu.service.impl.PasswordTokenManager#generateRecoveryToken(com.feiniu.model.User)
     */
    @Override
    ...
    /**
     * @see com.feiniu.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.feiniu.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.feiniu.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
